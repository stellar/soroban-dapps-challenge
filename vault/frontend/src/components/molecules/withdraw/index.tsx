...
import { withdraw } from 'vault-contract'
...
const Withdraw: FunctionComponent<IWithdraw> = ({
  account,
  tokenA,
  shareToken,
  reserves,
          ...
          <div className={styles.contentLeft}>
            <div className={styles.infoItem}>
              <div className={styles.label}>
                ...
                <Tooltip
                  title={
                    'Estimated price based on the last pool query. If at the time of submission the amount is lower than this, the transaction will be cancelled.'
                  }
                  placement="top"
                >
                  <div>
